...
// بعض الثوابت المستخدمة في التطبيق
...
const double CATEGORY_ICON_SIZE = 70; // حجم أيقونة الفئة
const double CATEGORY_CARD_RADIUS = 12.0; // زوايا البطاقة للفئة
const double CATEGORY_CARD_PADDING = 12.0; // الهوامش داخل البطاقة
